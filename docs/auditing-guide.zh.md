...
```bash
python skills/auditing/scripts/audit_project.py <project-root>        # markdown 报告
python skills/auditing/scripts/audit_project.py --json <project-root>  # JSON 输出
```
...
```bash
python skills/auditing/scripts/audit_skill.py <skill-directory>     # 质量 + 交叉引用
python skills/auditing/scripts/scan_security.py <skill-directory>   # 安全扫描
```
...
```bash
python skills/auditing/scripts/scan_security.py <project-root>           # 项目级扫描
python skills/auditing/scripts/scan_security.py <skill-directory>         # 单技能扫描
python skills/auditing/scripts/scan_security.py --json <project-root>     # JSON 输出
```
...
python skills/auditing/scripts/audit_project.py --json . > audit.json   # 编排 lint + security + docs + workflow
